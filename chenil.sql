...
INSERT INTO `races` (`racId`, `racName`) VALUES
(1, 'Labrador'),
(2, 'Border Collie'),
(3, 'Terre Neuve'),
(4, 'Maincoon'),
...
INSERT INTO `species` (`speId`, `speName`) VALUES
(1, 'Chiens'),
(2, 'Chats');
COMMIT;
...
CREATE TABLE `users` (
  ...
  `useForename` varchar(20) NOT NULL,
...
INSERT INTO `users` (`useId`, `useName`, `useForename`, `useDOB`, `useMail`, `useTel`) VALUES
(1, 'Clarat', 'Arnaud', DATE'1997-07-14', 'arnaud.clarat@ifosup.wavre.be', '+3210222026')
